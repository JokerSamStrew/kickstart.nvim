...
-- Function to open the selected URL in the default web browser
local function open_selected_url()
    ...
    for line = start_line, end_line do
        ...
        if line == start_line then
            -- For the first line, take from start_col to the end of the line
            table.insert(selected_lines, line_content:sub(start_col))
        elseif line == end_line then
            -- For the last line, take from the beginning to end_col
            table.insert(selected_lines, line_content:sub(1, end_col))
        else
            -- For lines in between, take the whole line
            table.insert(selected_lines, line_content)
        end
    end
    ...
    if url ~= "" then
        ...
        os.execute("open " .. vim.fn.shellescape(url))  -- For macOS
...
vim.keymap.set('v', '<Leader>fx', open_selected_url, { noremap = true })
